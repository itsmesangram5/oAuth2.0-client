...
@Repository
public class SpringSessionDao extends DAOImpl<SpringSessionRecord, com.getreferral.client.jooq.tables.pojos.SpringSession, String> {

    /**
     * Create a new SpringSessionDao without any configuration
     */
    public SpringSessionDao() {
        super(SpringSession.SPRING_SESSION, com.getreferral.client.jooq.tables.pojos.SpringSession.class);
    }
    ...
    public SpringSessionDao(Configuration configuration) {
        super(SpringSession.SPRING_SESSION, com.getreferral.client.jooq.tables.pojos.SpringSession.class, configuration);
    }

    @Override
    public String getId(com.getreferral.client.jooq.tables.pojos.SpringSession object) {
     ...
     * upperInclusive</code>
     */
    public List<com.getreferral.client.jooq.tables.pojos.SpringSession> fetchRangeOfPrimaryId(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.getreferral.client.jooq.tables.pojos.SpringSession> fetchByPrimaryId(String... values) {
     ...
     */
    public com.getreferral.client.jooq.tables.pojos.SpringSession fetchOneByPrimaryId(String value) {
     ...
     * Fetch a unique record that has <code>PRIMARY_ID = value</code>
     */
    public Optional<com.getreferral.client.jooq.tables.pojos.SpringSession> fetchOptionalByPrimaryId(String value) {
     ...
     * upperInclusive</code>
     */
    public List<com.getreferral.client.jooq.tables.pojos.SpringSession> fetchRangeOfSessionId(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.getreferral.client.jooq.tables.pojos.SpringSession> fetchBySessionId(String... values) {
     ...
     */
    public com.getreferral.client.jooq.tables.pojos.SpringSession fetchOneBySessionId(String value) {
     ...
     * Fetch a unique record that has <code>SESSION_ID = value</code>
     */
    public Optional<com.getreferral.client.jooq.tables.pojos.SpringSession> fetchOptionalBySessionId(String value) {
     ...
     * upperInclusive</code>
     */
    public List<com.getreferral.client.jooq.tables.pojos.SpringSession> fetchRangeOfCreationTime(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<com.getreferral.client.jooq.tables.pojos.SpringSession> fetchByCreationTime(Long... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.getreferral.client.jooq.tables.pojos.SpringSession> fetchRangeOfLastAccessTime(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<com.getreferral.client.jooq.tables.pojos.SpringSession> fetchByLastAccessTime(Long... values) {
     ...
     */
    public List<com.getreferral.client.jooq.tables.pojos.SpringSession> fetchRangeOfMaxInactiveInterval(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<com.getreferral.client.jooq.tables.pojos.SpringSession> fetchByMaxInactiveInterval(Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.getreferral.client.jooq.tables.pojos.SpringSession> fetchRangeOfExpiryTime(Long lowerInclusive, Long upperInclusive) {
     ...
     */
    public List<com.getreferral.client.jooq.tables.pojos.SpringSession> fetchByExpiryTime(Long... values) {
     ...
     * upperInclusive</code>
     */
    public List<com.getreferral.client.jooq.tables.pojos.SpringSession> fetchRangeOfPrincipalName(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<com.getreferral.client.jooq.tables.pojos.SpringSession> fetchByPrincipalName(String... values) {
